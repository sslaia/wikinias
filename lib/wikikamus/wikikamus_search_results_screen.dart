...
class WikikamusSearchResultsScreen extends StatefulWidget {
  ...
  const WikikamusSearchResultsScreen({super.key, required this.query});

  @override
  State<WikikamusSearchResultsScreen> createState() =>
      _WikikamusSearchResultsScreenState();
}

class _WikikamusSearchResultsScreenState
    extends State<WikikamusSearchResultsScreen> {
  ...
  Future<void> _fetchSearchResults() async {
    ...
    try {
      final results = await _searchApiService.searchWikikamus(widget.query);
      setState(() {
