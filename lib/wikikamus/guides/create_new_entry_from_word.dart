...
class CreateNewEntryFromWordScreen extends StatefulWidget {
  final String title;
  const CreateNewEntryFromWordScreen({super.key, required this.title});

  @override
  State<CreateNewEntryFromWordScreen> createState() => _CreateNewEntryFromWordScreenState();
}

class _CreateNewEntryFromWordScreenState extends State<CreateNewEntryFromWordScreen> {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: DropdownButtonFormField<String>(
                    decoration: InputDecoration(
                      labelText: 'Halö ndroto wehede si faudu',
                      border: OutlineInputBorder(),
                    ),
