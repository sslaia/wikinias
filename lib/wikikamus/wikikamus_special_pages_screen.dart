...
class _WikikamusSpecialPagesScreenState
  ...
  void _navigateToNewPage(String pageTitle) {
    Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (context) => WikikamusSpecialPagesScreen(title: pageTitle),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final String pageImagePath = "assets/images/ornament3.webp";
        ...
        body: CustomScrollView(
          slivers: [
            SliverAppBar(
              ...
              title: Text(processedTitle(widget.title), style: TextStyle(color: color, fontSize: bodyFontSize * 1.0)),
              floating: true,
              expandedHeight: 230,
