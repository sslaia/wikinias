...
class WiktionaryScreen extends StatefulWidget {
  const WiktionaryScreen(
      {super.key});

  @override
  State<WiktionaryScreen> createState() => _WiktionaryScreenState();
}

class _WiktionaryScreenState extends State<WiktionaryScreen> {
  late final WebViewController _controller;
  var loadingProgress = 0;

  // Keys
  final GlobalKey wiktionaryKey = GlobalKey();
  ...
  void initState() {
    ...
    var initialUrl = 'https://nia.m.wiktionary.org';
      ...
      child: SafeArea(
        child: Consumer<WikiProvider>(
          builder: (context, wiki, child) => Scaffold(
            ...
            body: Stack(
              children: [
                WebViewWidget(key: wiktionaryKey, controller: _controller),
